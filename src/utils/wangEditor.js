...
*/
  ...
  Image.prototype = {
    ...
    _createEditPanel: function _createEditPanel() {
      ...
      var customInput = getRandom('custom-input');
      ...
      var tabsConfig = [
        {
          ...
          tpl: `
            <div>
              <div class="w-e-button-container" style="border-bottom:1px solid #f1f1f1;padding-bottom:5px;margin-bottom:5px;">
                <span style="float:left;font-size:14px;margin:4px 5px 0 5px;color:#333;">图片宽度</span>
                <button type="button" id="${width30}" class="left">30%</button>
                <button type="button" id="${width50}" class="left">50%</button>
                <button type="button" id="${width100}" class="left">100%</button>
              </div>
              <div style="border-bottom: 1px solid #f1f1f1; padding-bottom: 5px; margin-bottom: 5px;">
                ...
                <input id="${customInput}" style="outline: none; border: 1px solid #999; width: 30%; margin-left: 10px; margin-right: 10px;" class="left" type="number" />%
              </div>
              <div class="w-e-button-container">
                <button type="button" style="padding-left: 5px; color: #000;" id="${delBtn}" class="gray left">删除图片</button>
              </div>
            </div>
            `,
          events: [
